...
namespace Stencils {
  ...
  class TransportViscosityBufferFillStencil: public BoundaryStencil<TurbulentFlowField> {
  public:
    /**
     ...
     */
    TransportViscosityBufferFillStencil(const Parameters& parameters);
    /**
     * @brief Destroy the Viscosity Buffer Fill Stencil object
     *
     */
    ~TransportViscosityBufferFillStencil() override = default;
    ...
    std::unique_ptr<RealType[]> leftTransportViscosityFillBuffer;
        /**
     * @brief pointer to the fillbuffer to the right wall
     *
     */

    std::unique_ptr<RealType[]> rightTransportViscosityFillBuffer;
        /**
     * @brief pointer to the fillbuffer to the top wall
     *
     */

    std::unique_ptr<RealType[]> topTransportViscosityFillBuffer;
        /**
     * @brief pointer to the fillbuffer to the bottom wall
     *
     */

    std::unique_ptr<RealType[]> bottomTransportViscosityFillBuffer;
        /**
     * @brief pointer to the fillbuffer to the front wall
     *
     */

    std::unique_ptr<RealType[]> frontTransportViscosityFillBuffer;
        /**
     * @brief pointer to the fillbuffer to the back wall
     *
     */

    std::unique_ptr<RealType[]> backTransportViscosityFillBuffer;
